    ...
    <section className={classes.background}>
      <div className="container">
        <div>
          ...
          :
            <h3 className={`${classes.title} ${classes.henni}`}>What do I do and why?</h3>
          }
        </div>
        <section className={classes.info}>
          ...
          <article>
            ...
            :
              <p className={`${classes.typewriter} shadow`}>My interests are in the field of modern and contemporary art and literature, 19th century literature, forensic linguistics and criminal mind, the existence of consciousness and soul, perceptions, mental process, expressionism, abstractionism, and others.</p>
            }
