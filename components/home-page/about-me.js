      ...
      <div className="container">
        ...
        <section className={classes.info}>
          <article className={classes.display}>
            {bulgarian ?
              <h4 className={classes.bgTitleAnother}>О, вий, които имате очи печални, с безкрая синкав на морето ги хранете</h4>
            :
          ...
          <article>
            ...
            { bulgarian ? 
              <p className="bgFont shadow">Интересите ми са в областта на модерното и съвременното изкуство и литература, литературата на XIXв., криминалната лингвистика и криминалния ум, съществуването на съзнанието и душата, възприятията, психическия процес, експресионизма, абстракционизма и др.</p>
            :
            ...
            { bulgarian ? 
              <p className="bgFont shadow">Рисувам, вдъхновена от емоционалния свят, както и от символното значение на природата и социалните роли. Работя предимно с акрил и смесена техника. За мен рисуването е израз на специфични усещания без претенция за техническо съвършенство.</p>
            :
